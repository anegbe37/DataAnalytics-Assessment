/**
 * Purpose: Analyze customer transaction frequency and categorize customers
 * This query analyzes the average monthly transaction frequency of customers
 * and groups them into High, Medium, and Low frequency categories.
 */
