/**
 * Purpose: Identify inactive plans based on transaction dates
 * This query finds plans that have had no transaction activity for more than 365 days,
 * helping to identify dormant accounts that may need follow-up.
 */
